...
#ifndef YY_PPY_TOOLS_WIDL_PPY_TAB_H_INCLUDED
# define YY_PPY_TOOLS_WIDL_PPY_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef PPY_DEBUG
# if defined YYDEBUG
#if YYDEBUG
...
#endif /* !YY_PPY_TOOLS_WIDL_PPY_TAB_H_INCLUDED  */
