/*** Autogenerated by WIDL 10.0-rc2 from include/wine/winedxgi.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IWineDXGISwapChainFactory_QueryInterface(IWineDXGISwapChainFactory* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IWineDXGISwapChainFactory_AddRef(IWineDXGISwapChainFactory* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IWineDXGISwapChainFactory_Release(IWineDXGISwapChainFactory* This) {
    return This->lpVtbl->Release(This);
}
/*** IWineDXGISwapChainFactory methods ***/
static inline HRESULT IWineDXGISwapChainFactory_create_swapchain(IWineDXGISwapChainFactory* This,IDXGIFactory *factory,HWND window,const DXGI_SWAP_CHAIN_DESC1 *desc,const DXGI_SWAP_CHAIN_FULLSCREEN_DESC *fullscreen_desc,IDXGIOutput *output,IDXGISwapChain1 **swapchain) {
...
{
    virtual HRESULT STDMETHODCALLTYPE create_resource(
...
typedef struct IWineDXGIDeviceVtbl {
    ...
    HRESULT (STDMETHODCALLTYPE *create_resource)(
        IWineDXGIDevice *This,
        struct wined3d_resource *wined3d_resource,
        DXGI_USAGE usage,
        const DXGI_SHARED_RESOURCE *shared_resource,
...
/*** IWineDXGIDevice methods ***/
#define IWineDXGIDevice_create_resource(This,wined3d_resource,usage,shared_resource,outer,needs_surface,resource) (This)->lpVtbl->create_resource(This,wined3d_resource,usage,shared_resource,outer,needs_surface,resource)
#else
/*** IUnknown methods ***/
static inline HRESULT IWineDXGIDevice_QueryInterface(IWineDXGIDevice* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IWineDXGIDevice_AddRef(IWineDXGIDevice* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IWineDXGIDevice_Release(IWineDXGIDevice* This) {
    return This->lpVtbl->Release(This);
}
/*** IDXGIObject methods ***/
static inline HRESULT IWineDXGIDevice_SetPrivateData(IWineDXGIDevice* This,REFGUID guid,UINT data_size,const void *data) {
    return This->lpVtbl->SetPrivateData(This,guid,data_size,data);
}
static inline HRESULT IWineDXGIDevice_SetPrivateDataInterface(IWineDXGIDevice* This,REFGUID guid,const IUnknown *object) {
    return This->lpVtbl->SetPrivateDataInterface(This,guid,object);
}
static inline HRESULT IWineDXGIDevice_GetPrivateData(IWineDXGIDevice* This,REFGUID guid,UINT *data_size,void *data) {
    return This->lpVtbl->GetPrivateData(This,guid,data_size,data);
}
static inline HRESULT IWineDXGIDevice_GetParent(IWineDXGIDevice* This,REFIID riid,void **parent) {
    return This->lpVtbl->GetParent(This,riid,parent);
}
/*** IDXGIDevice methods ***/
static inline HRESULT IWineDXGIDevice_GetAdapter(IWineDXGIDevice* This,IDXGIAdapter **adapter) {
    return This->lpVtbl->GetAdapter(This,adapter);
}
static inline HRESULT IWineDXGIDevice_CreateSurface(IWineDXGIDevice* This,const DXGI_SURFACE_DESC *desc,UINT surface_count,DXGI_USAGE usage,const DXGI_SHARED_RESOURCE *shared_resource,IDXGISurface **surface) {
    return This->lpVtbl->CreateSurface(This,desc,surface_count,usage,shared_resource,surface);
}
static inline HRESULT IWineDXGIDevice_QueryResourceResidency(IWineDXGIDevice* This,IUnknown *const *resources,DXGI_RESIDENCY *residency,UINT resource_count) {
    return This->lpVtbl->QueryResourceResidency(This,resources,residency,resource_count);
}
static inline HRESULT IWineDXGIDevice_SetGPUThreadPriority(IWineDXGIDevice* This,INT priority) {
    return This->lpVtbl->SetGPUThreadPriority(This,priority);
}
static inline HRESULT IWineDXGIDevice_GetGPUThreadPriority(IWineDXGIDevice* This,INT *priority) {
    return This->lpVtbl->GetGPUThreadPriority(This,priority);
}
/*** IDXGIDevice1 methods ***/
static inline HRESULT IWineDXGIDevice_SetMaximumFrameLatency(IWineDXGIDevice* This,UINT MaxLatency) {
    return This->lpVtbl->SetMaximumFrameLatency(This,MaxLatency);
}
static inline HRESULT IWineDXGIDevice_GetMaximumFrameLatency(IWineDXGIDevice* This,UINT *pMaxLatency) {
    return This->lpVtbl->GetMaximumFrameLatency(This,pMaxLatency);
}
/*** IDXGIDevice2 methods ***/
static inline HRESULT IWineDXGIDevice_OfferResources(IWineDXGIDevice* This,UINT NumResources,IDXGIResource *const *ppResources,DXGI_OFFER_RESOURCE_PRIORITY Priority) {
    return This->lpVtbl->OfferResources(This,NumResources,ppResources,Priority);
}
static inline HRESULT IWineDXGIDevice_ReclaimResources(IWineDXGIDevice* This,UINT NumResources,IDXGIResource *const *ppResources,BOOL *pDiscarded) {
    return This->lpVtbl->ReclaimResources(This,NumResources,ppResources,pDiscarded);
}
static inline HRESULT IWineDXGIDevice_EnqueueSetEvent(IWineDXGIDevice* This,HANDLE hEvent) {
    return This->lpVtbl->EnqueueSetEvent(This,hEvent);
}
/*** IDXGIDevice3 methods ***/
static inline void IWineDXGIDevice_Trim(IWineDXGIDevice* This) {
    This->lpVtbl->Trim(This);
}
/*** IWineDXGIDevice methods ***/
static inline HRESULT IWineDXGIDevice_create_resource(IWineDXGIDevice* This,struct wined3d_resource *wined3d_resource,DXGI_USAGE usage,const DXGI_SHARED_RESOURCE *shared_resource,IUnknown *outer,BOOL needs_surface,void **resource) {
    return This->lpVtbl->create_resource(This,wined3d_resource,usage,shared_resource,outer,needs_surface,resource);
}
#endif
#endif
...
IWineDXGIDeviceParent : public IUnknown
{
    ...
    virtual HRESULT STDMETHODCALLTYPE register_swapchain_texture(
        struct wined3d_texture *texture,
        unsigned int texture_flags,
        IDXGISurface **ret_surface) = 0;
...
typedef struct IWineDXGIDeviceParentVtbl {
    ...
    HRESULT (STDMETHODCALLTYPE *register_swapchain_texture)(
        IWineDXGIDeviceParent *This,
        struct wined3d_texture *texture,
        unsigned int texture_flags,
...
#define IWineDXGIDeviceParent_register_swapchain_texture(This,texture,texture_flags,ret_surface) (This)->lpVtbl->register_swapchain_texture(This,texture,texture_flags,ret_surface)
#else
/*** IUnknown methods ***/
static inline HRESULT IWineDXGIDeviceParent_QueryInterface(IWineDXGIDeviceParent* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IWineDXGIDeviceParent_AddRef(IWineDXGIDeviceParent* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IWineDXGIDeviceParent_Release(IWineDXGIDeviceParent* This) {
    return This->lpVtbl->Release(This);
}
/*** IWineDXGIDeviceParent methods ***/
static inline struct wined3d_device_parent * IWineDXGIDeviceParent_get_wined3d_device_parent(IWineDXGIDeviceParent* This) {
    return This->lpVtbl->get_wined3d_device_parent(This);
}
static inline HRESULT IWineDXGIDeviceParent_register_swapchain_texture(IWineDXGIDeviceParent* This,struct wined3d_texture *texture,unsigned int texture_flags,IDXGISurface **ret_surface) {
    return This->lpVtbl->register_swapchain_texture(This,texture,texture_flags,ret_surface);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static inline HRESULT IWineDXGIAdapter_QueryInterface(IWineDXGIAdapter* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IWineDXGIAdapter_AddRef(IWineDXGIAdapter* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IWineDXGIAdapter_Release(IWineDXGIAdapter* This) {
    return This->lpVtbl->Release(This);
}
/*** IDXGIObject methods ***/
static inline HRESULT IWineDXGIAdapter_SetPrivateData(IWineDXGIAdapter* This,REFGUID guid,UINT data_size,const void *data) {
    return This->lpVtbl->SetPrivateData(This,guid,data_size,data);
}
static inline HRESULT IWineDXGIAdapter_SetPrivateDataInterface(IWineDXGIAdapter* This,REFGUID guid,const IUnknown *object) {
    return This->lpVtbl->SetPrivateDataInterface(This,guid,object);
}
static inline HRESULT IWineDXGIAdapter_GetPrivateData(IWineDXGIAdapter* This,REFGUID guid,UINT *data_size,void *data) {
    return This->lpVtbl->GetPrivateData(This,guid,data_size,data);
}
static inline HRESULT IWineDXGIAdapter_GetParent(IWineDXGIAdapter* This,REFIID riid,void **parent) {
    return This->lpVtbl->GetParent(This,riid,parent);
}
/*** IDXGIAdapter methods ***/
static inline HRESULT IWineDXGIAdapter_EnumOutputs(IWineDXGIAdapter* This,UINT output_idx,IDXGIOutput **output) {
    return This->lpVtbl->EnumOutputs(This,output_idx,output);
}
static inline HRESULT IWineDXGIAdapter_GetDesc(IWineDXGIAdapter* This,DXGI_ADAPTER_DESC *desc) {
    return This->lpVtbl->GetDesc(This,desc);
}
static inline HRESULT IWineDXGIAdapter_CheckInterfaceSupport(IWineDXGIAdapter* This,REFGUID guid,LARGE_INTEGER *umd_version) {
    return This->lpVtbl->CheckInterfaceSupport(This,guid,umd_version);
}
/*** IDXGIAdapter1 methods ***/
static inline HRESULT IWineDXGIAdapter_GetDesc1(IWineDXGIAdapter* This,DXGI_ADAPTER_DESC1 *pDesc) {
    return This->lpVtbl->GetDesc1(This,pDesc);
}
/*** IDXGIAdapter2 methods ***/
static inline HRESULT IWineDXGIAdapter_GetDesc2(IWineDXGIAdapter* This,DXGI_ADAPTER_DESC2 *pDesc) {
    return This->lpVtbl->GetDesc2(This,pDesc);
}
/*** IDXGIAdapter3 methods ***/
static inline HRESULT IWineDXGIAdapter_RegisterHardwareContentProtectionTeardownStatusEvent(IWineDXGIAdapter* This,HANDLE event,DWORD *cookie) {
    return This->lpVtbl->RegisterHardwareContentProtectionTeardownStatusEvent(This,event,cookie);
}
static inline void IWineDXGIAdapter_UnregisterHardwareContentProtectionTeardownStatus(IWineDXGIAdapter* This,DWORD cookie) {
    This->lpVtbl->UnregisterHardwareContentProtectionTeardownStatus(This,cookie);
}
static inline HRESULT IWineDXGIAdapter_QueryVideoMemoryInfo(IWineDXGIAdapter* This,UINT node_index,DXGI_MEMORY_SEGMENT_GROUP segment_group,DXGI_QUERY_VIDEO_MEMORY_INFO *memory_info) {
    return This->lpVtbl->QueryVideoMemoryInfo(This,node_index,segment_group,memory_info);
}
static inline HRESULT IWineDXGIAdapter_SetVideoMemoryReservation(IWineDXGIAdapter* This,UINT node_index,DXGI_MEMORY_SEGMENT_GROUP segment_group,UINT64 reservation) {
    return This->lpVtbl->SetVideoMemoryReservation(This,node_index,segment_group,reservation);
}
static inline HRESULT IWineDXGIAdapter_RegisterVideoMemoryBudgetChangeNotificationEvent(IWineDXGIAdapter* This,HANDLE event,DWORD *cookie) {
    return This->lpVtbl->RegisterVideoMemoryBudgetChangeNotificationEvent(This,event,cookie);
}
static inline void IWineDXGIAdapter_UnregisterVideoMemoryBudgetChangeNotification(IWineDXGIAdapter* This,DWORD cookie) {
    This->lpVtbl->UnregisterVideoMemoryBudgetChangeNotification(This,cookie);
}
/*** IDXGIAdapter4 methods ***/
static inline HRESULT IWineDXGIAdapter_GetDesc3(IWineDXGIAdapter* This,DXGI_ADAPTER_DESC3 *desc) {
    return This->lpVtbl->GetDesc3(This,desc);
}
/*** IWineDXGIAdapter methods ***/
static inline HRESULT IWineDXGIAdapter_get_adapter_info(IWineDXGIAdapter* This,struct wine_dxgi_adapter_info *info) {
...
IWineDXGIFactory : public IDXGIFactory7
{
};
#ifdef __CRT_UUID_DECL
...
/*** IDXGIFactory6 methods ***/
#define IWineDXGIFactory_EnumAdapterByGpuPreference(This,adapter_idx,gpu_preference,iid,adapter) (This)->lpVtbl->EnumAdapterByGpuPreference(This,adapter_idx,gpu_preference,iid,adapter)
/*** IDXGIFactory7 methods ***/
#define IWineDXGIFactory_RegisterAdaptersChangedEvent(This,event,cookie) (This)->lpVtbl->RegisterAdaptersChangedEvent(This,event,cookie)
#define IWineDXGIFactory_UnregisterAdaptersChangedEvent(This,cookie) (This)->lpVtbl->UnregisterAdaptersChangedEvent(This,cookie)
#else
/*** IUnknown methods ***/
static inline HRESULT IWineDXGIFactory_QueryInterface(IWineDXGIFactory* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IWineDXGIFactory_AddRef(IWineDXGIFactory* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IWineDXGIFactory_Release(IWineDXGIFactory* This) {
    return This->lpVtbl->Release(This);
}
/*** IDXGIObject methods ***/
static inline HRESULT IWineDXGIFactory_SetPrivateData(IWineDXGIFactory* This,REFGUID guid,UINT data_size,const void *data) {
    return This->lpVtbl->SetPrivateData(This,guid,data_size,data);
}
static inline HRESULT IWineDXGIFactory_SetPrivateDataInterface(IWineDXGIFactory* This,REFGUID guid,const IUnknown *object) {
    return This->lpVtbl->SetPrivateDataInterface(This,guid,object);
}
static inline HRESULT IWineDXGIFactory_GetPrivateData(IWineDXGIFactory* This,REFGUID guid,UINT *data_size,void *data) {
    return This->lpVtbl->GetPrivateData(This,guid,data_size,data);
}
static inline HRESULT IWineDXGIFactory_GetParent(IWineDXGIFactory* This,REFIID riid,void **parent) {
    return This->lpVtbl->GetParent(This,riid,parent);
}
/*** IDXGIFactory methods ***/
static inline HRESULT IWineDXGIFactory_EnumAdapters(IWineDXGIFactory* This,UINT adapter_idx,IDXGIAdapter **adapter) {
    return This->lpVtbl->EnumAdapters(This,adapter_idx,adapter);
}
static inline HRESULT IWineDXGIFactory_MakeWindowAssociation(IWineDXGIFactory* This,HWND window,UINT flags) {
    return This->lpVtbl->MakeWindowAssociation(This,window,flags);
}
static inline HRESULT IWineDXGIFactory_GetWindowAssociation(IWineDXGIFactory* This,HWND *window) {
    return This->lpVtbl->GetWindowAssociation(This,window);
}
static inline HRESULT IWineDXGIFactory_CreateSwapChain(IWineDXGIFactory* This,IUnknown *device,DXGI_SWAP_CHAIN_DESC *desc,IDXGISwapChain **swapchain) {
    return This->lpVtbl->CreateSwapChain(This,device,desc,swapchain);
}
static inline HRESULT IWineDXGIFactory_CreateSoftwareAdapter(IWineDXGIFactory* This,HMODULE swrast,IDXGIAdapter **adapter) {
    return This->lpVtbl->CreateSoftwareAdapter(This,swrast,adapter);
}
/*** IDXGIFactory1 methods ***/
static inline HRESULT IWineDXGIFactory_EnumAdapters1(IWineDXGIFactory* This,UINT Adapter,IDXGIAdapter1 **ppAdapter) {
    return This->lpVtbl->EnumAdapters1(This,Adapter,ppAdapter);
}
static inline BOOL IWineDXGIFactory_IsCurrent(IWineDXGIFactory* This) {
    return This->lpVtbl->IsCurrent(This);
}
/*** IDXGIFactory2 methods ***/
static inline BOOL IWineDXGIFactory_IsWindowedStereoEnabled(IWineDXGIFactory* This) {
    return This->lpVtbl->IsWindowedStereoEnabled(This);
}
static inline HRESULT IWineDXGIFactory_CreateSwapChainForHwnd(IWineDXGIFactory* This,IUnknown *pDevice,HWND hWnd,const DXGI_SWAP_CHAIN_DESC1 *pDesc,const DXGI_SWAP_CHAIN_FULLSCREEN_DESC *pFullscreenDesc,IDXGIOutput *pRestrictToOutput,IDXGISwapChain1 **ppSwapChain) {
    return This->lpVtbl->CreateSwapChainForHwnd(This,pDevice,hWnd,pDesc,pFullscreenDesc,pRestrictToOutput,ppSwapChain);
}
static inline HRESULT IWineDXGIFactory_CreateSwapChainForCoreWindow(IWineDXGIFactory* This,IUnknown *pDevice,IUnknown *pWindow,const DXGI_SWAP_CHAIN_DESC1 *pDesc,IDXGIOutput *pRestrictToOutput,IDXGISwapChain1 **ppSwapChain) {
    return This->lpVtbl->CreateSwapChainForCoreWindow(This,pDevice,pWindow,pDesc,pRestrictToOutput,ppSwapChain);
}
static inline HRESULT IWineDXGIFactory_GetSharedResourceAdapterLuid(IWineDXGIFactory* This,HANDLE hResource,LUID *pLuid) {
    return This->lpVtbl->GetSharedResourceAdapterLuid(This,hResource,pLuid);
}
static inline HRESULT IWineDXGIFactory_RegisterStereoStatusWindow(IWineDXGIFactory* This,HWND WindowHandle,UINT wMsg,DWORD *pdwCookie) {
    return This->lpVtbl->RegisterStereoStatusWindow(This,WindowHandle,wMsg,pdwCookie);
}
static inline HRESULT IWineDXGIFactory_RegisterStereoStatusEvent(IWineDXGIFactory* This,HANDLE hEvent,DWORD *pdwCookie) {
    return This->lpVtbl->RegisterStereoStatusEvent(This,hEvent,pdwCookie);
}
static inline void IWineDXGIFactory_UnregisterStereoStatus(IWineDXGIFactory* This,DWORD dwCookie) {
    This->lpVtbl->UnregisterStereoStatus(This,dwCookie);
}
static inline HRESULT IWineDXGIFactory_RegisterOcclusionStatusWindow(IWineDXGIFactory* This,HWND WindowHandle,UINT wMsg,DWORD *pdwCookie) {
    return This->lpVtbl->RegisterOcclusionStatusWindow(This,WindowHandle,wMsg,pdwCookie);
}
static inline HRESULT IWineDXGIFactory_RegisterOcclusionStatusEvent(IWineDXGIFactory* This,HANDLE hEvent,DWORD *pdwCookie) {
    return This->lpVtbl->RegisterOcclusionStatusEvent(This,hEvent,pdwCookie);
}
static inline void IWineDXGIFactory_UnregisterOcclusionStatus(IWineDXGIFactory* This,DWORD dwCookie) {
    This->lpVtbl->UnregisterOcclusionStatus(This,dwCookie);
}
static inline HRESULT IWineDXGIFactory_CreateSwapChainForComposition(IWineDXGIFactory* This,IUnknown *pDevice,const DXGI_SWAP_CHAIN_DESC1 *pDesc,IDXGIOutput *pRestrictToOutput,IDXGISwapChain1 **ppSwapChain) {
    return This->lpVtbl->CreateSwapChainForComposition(This,pDevice,pDesc,pRestrictToOutput,ppSwapChain);
}
/*** IDXGIFactory3 methods ***/
static inline UINT IWineDXGIFactory_GetCreationFlags(IWineDXGIFactory* This) {
    return This->lpVtbl->GetCreationFlags(This);
}
/*** IDXGIFactory4 methods ***/
static inline HRESULT IWineDXGIFactory_EnumAdapterByLuid(IWineDXGIFactory* This,LUID luid,REFIID iid,void **adapter) {
    return This->lpVtbl->EnumAdapterByLuid(This,luid,iid,adapter);
}
static inline HRESULT IWineDXGIFactory_EnumWarpAdapter(IWineDXGIFactory* This,REFIID iid,void **adapter) {
    return This->lpVtbl->EnumWarpAdapter(This,iid,adapter);
}
/*** IDXGIFactory5 methods ***/
static inline HRESULT IWineDXGIFactory_CheckFeatureSupport(IWineDXGIFactory* This,DXGI_FEATURE feature,void *support_data,UINT support_data_size) {
    return This->lpVtbl->CheckFeatureSupport(This,feature,support_data,support_data_size);
}
/*** IDXGIFactory6 methods ***/
static inline HRESULT IWineDXGIFactory_EnumAdapterByGpuPreference(IWineDXGIFactory* This,UINT adapter_idx,DXGI_GPU_PREFERENCE gpu_preference,REFIID iid,void **adapter) {
    return This->lpVtbl->EnumAdapterByGpuPreference(This,adapter_idx,gpu_preference,iid,adapter);
}
/*** IDXGIFactory7 methods ***/
static inline HRESULT IWineDXGIFactory_RegisterAdaptersChangedEvent(IWineDXGIFactory* This,HANDLE event,DWORD *cookie) {
    return This->lpVtbl->RegisterAdaptersChangedEvent(This,event,cookie);
}
static inline HRESULT IWineDXGIFactory_UnregisterAdaptersChangedEvent(IWineDXGIFactory* This,DWORD cookie) {
