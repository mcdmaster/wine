/*** Autogenerated by WIDL 10.0-rc2 from include/wine/mfinternal.idl - Do not edit ***/
...
#ifndef __IMFMediaShutdownNotify_FWD_DEFINED__
#define __IMFMediaShutdownNotify_FWD_DEFINED__
typedef interface IMFMediaShutdownNotify IMFMediaShutdownNotify;
#ifdef __cplusplus
interface IMFMediaShutdownNotify;
#endif /* __cplusplus */
#endif
...
/*****************************************************************************
 * IMFMediaShutdownNotify interface
 */
#ifndef __IMFMediaShutdownNotify_INTERFACE_DEFINED__
#define __IMFMediaShutdownNotify_INTERFACE_DEFINED__

DEFINE_GUID(IID_IMFMediaShutdownNotify, 0x0aab315c, 0x33a4, 0x43db, 0xaf,0x6b, 0xc9,0xc8,0x69,0x21,0x03,0x4e);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("0aab315c-33a4-43db-af6b-c9c86921034e")
IMFMediaShutdownNotify : public IUnknown
{
    virtual HRESULT STDMETHODCALLTYPE set_notification_callback(
        IMFAsyncCallback *callback,
        IUnknown *state) = 0;

};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IMFMediaShutdownNotify, 0x0aab315c, 0x33a4, 0x43db, 0xaf,0x6b, 0xc9,0xc8,0x69,0x21,0x03,0x4e)
#endif
#else
typedef struct IMFMediaShutdownNotifyVtbl {
    BEGIN_INTERFACE

    /*** IUnknown methods ***/
    HRESULT (STDMETHODCALLTYPE *QueryInterface)(
        IMFMediaShutdownNotify *This,
        REFIID riid,
        void **ppvObject);
    ...
    /*** IMFMediaShutdownNotify methods ***/
    HRESULT (STDMETHODCALLTYPE *set_notification_callback)(
        IMFMediaShutdownNotify *This,
        IMFAsyncCallback *callback,
        IUnknown *state);

    END_INTERFACE
} IMFMediaShutdownNotifyVtbl;

interface IMFMediaShutdownNotify {
    CONST_VTBL IMFMediaShutdownNotifyVtbl* lpVtbl;
};

#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
#define IMFMediaShutdownNotify_QueryInterface(This,riid,ppvObject) (This)->lpVtbl->QueryInterface(This,riid,ppvObject)
#define IMFMediaShutdownNotify_AddRef(This) (This)->lpVtbl->AddRef(This)
#define IMFMediaShutdownNotify_Release(This) (This)->lpVtbl->Release(This)
/*** IMFMediaShutdownNotify methods ***/
#define IMFMediaShutdownNotify_set_notification_callback(This,callback,state) (This)->lpVtbl->set_notification_callback(This,callback,state)
#else
/*** IUnknown methods ***/
static inline HRESULT IMFMediaShutdownNotify_QueryInterface(IMFMediaShutdownNotify* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IMFMediaShutdownNotify_AddRef(IMFMediaShutdownNotify* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IMFMediaShutdownNotify_Release(IMFMediaShutdownNotify* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFMediaShutdownNotify methods ***/
static inline HRESULT IMFMediaShutdownNotify_set_notification_callback(IMFMediaShutdownNotify* This,IMFAsyncCallback *callback,IUnknown *state) {
    return This->lpVtbl->set_notification_callback(This,callback,state);
}
#endif
#endif
...
#endif  /* __IMFMediaShutdownNotify_INTERFACE_DEFINED__ */
