/*** Autogenerated by WIDL 10.0-rc2 from include/wine/fil_data.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IAMFilterData_QueryInterface(IAMFilterData* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IAMFilterData_AddRef(IAMFilterData* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IAMFilterData_Release(IAMFilterData* This) {
    return This->lpVtbl->Release(This);
}
/*** IAMFilterData methods ***/
static inline HRESULT IAMFilterData_ParseFilterData(IAMFilterData* This,BYTE *data,ULONG size,BYTE **regfilter) {
    return This->lpVtbl->ParseFilterData(This,data,size,regfilter);
}
static inline HRESULT IAMFilterData_CreateFilterData(IAMFilterData* This,REGFILTER2 *regfilter,BYTE **data,ULONG *size) {
