...
static NTSTATUS wow64_create_font_object(void *args)
{
    ...
    enum params create_font_object_params
    {
...
static NTSTATUS wow64_release_font_object(void *args)
{
    ...
    enum params release_font_object_params
    {
        params32->object
    };
...
static NTSTATUS wow64_get_glyph_outline(void *args)
{
    ...
    enum params get_glyph_outline_params
    {
        params32->object,
...
static NTSTATUS wow64_get_glyph_count(void *args)
{
    ...
    enum params get_glyph_count_params
    {
        params32->object,
...
static NTSTATUS wow64_get_glyph_advance(void *args)
{
    ...
    enum params get_glyph_advance_params
    {
        params32->object,
        params32->glyph,
        params32->mode,
...
static NTSTATUS wow64_get_glyph_bbox(void *args)
{
    ...
    enum params get_glyph_bbox_params
    {
        params32->object,
        params32->simulations,
        params32->glyph,
...
static NTSTATUS wow64_get_glyph_bitmap(void *args)
{
    ...
    enum params get_glyph_bitmap_params
    {
        params32->object,
        params32->simulations,
        params32->glyph,
...
static NTSTATUS wow64_get_design_glyph_metrics(void *args)
{
    ...
    enum params get_design_glyph_metrics_params
    {
        params32->object,
        params32->simulations,
        params32->glyph,
