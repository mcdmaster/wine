...
static const unsigned short IObjectSafety_FormatStringOffsetTable[] =
{
    ...
    48,  /* IObjectSafety::SetInterfaceSafetyOptions */
};
...
/* 42 (return value) */
        ...
        0x08,	/* FC_LONG */
        0x0,
/* 48 (procedure IObjectSafety::SetInterfaceSafetyOptions) */
        0x33,	/* FC_AUTO_HANDLE */
        0x6c,
        NdrFcLong(0x0),
...
/* 72 (parameter riid) */
        ...
        NdrFcShort(0x4),	/* stack offset = 4 */
        NdrFcShort(0x8),	/* type offset = 8 */
/* 78 (parameter dwOptionSetMask) */
        NdrFcShort(0x48),	/* flags: in, base type */
        NdrFcShort(0x8),	/* stack offset = 8 */
        0x08,	/* FC_LONG */
        0x0,
/* 84 (parameter dwEnabledOptions) */
        NdrFcShort(0x48),	/* flags: in, base type */
        NdrFcShort(0xc),	/* stack offset = 12 */
        0x08,	/* FC_LONG */
        0x0,
